...
const STAGE_PALETTE: Record<string, { bg: string; border: string; text: string; dot: string }> = {
  initial_access:    { bg: "#1a1000", border: "#f97316", text: "#fdba74", dot: "#f97316" },
  credential_access: { bg: "#1a1a00", border: "#eab308", text: "#fde047", dot: "#eab308" },
  lateral_movement:  { bg: "#12001a", border: "#a855f7", text: "#d8b4fe", dot: "#a855f7" },
  exfiltration:      { bg: "#1a0000", border: "#ef4444", text: "#fca5a5", dot: "#ef4444" },
  impact:            { bg: "#1a0000", border: "#dc2626", text: "#fca5a5", dot: "#dc2626" },
  service:           { bg: "#111827", border: "#374151", text: "#9ca3af", dot: "#4b5563" },
};
...
export function AttackChainGraph({ scan }: { scan: ScanState }) {
  const chain: AttackChain = scan.attack_chain ?? { nodes: [], edges: [], narrative: "", mermaid: "" };
